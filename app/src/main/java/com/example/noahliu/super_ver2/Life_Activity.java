...
public class Life_Activity extends AppCompatActivity
    ...
    String urladdress="http://120.109.18.143/joomla/fatty/ResultMembershipdata3.php";
    String[] title;
    String[] script;
    String[] img;
    ListView listView2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView2 = (ListView) findViewById(R.id.lview3);

        StrictMode.setThreadPolicy((new StrictMode.ThreadPolicy.Builder().permitNetwork().build()));

        collectData();
        CustomListView2 customListView = new CustomListView2(this,title,script,img);
...
//                img[i]=jo.getString("photo");
    ...
    public class CustomListView2 extends ArrayAdapter<String> {
        ...
        Bitmap bitmap;
        public CustomListView2(Activity context,String[] title,String[] script,String[] img) {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent){
            ...
            new CustomListView2.GetImageFromURL(viewHolder.ivw).execute(img[position]);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.life_, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent gofood = new Intent(Life_Activity.this,Food_Activity.class);
            startActivity(gofood);
            finish();
        } else if (id == R.id.nav_beverage) {
            Intent gobeverage = new Intent(Life_Activity.this,Beverage_Activity.class);
