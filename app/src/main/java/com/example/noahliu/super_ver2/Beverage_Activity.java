...
public class Beverage_Activity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    String urladdress="http://120.109.18.143/joomla/fatty/ResultMembershipdata.php";
    String[] title1;
    String[] script;
    String[] img;
    ListView listView1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beverage_);
        ...
        listView1 = (ListView) findViewById(R.id.lviewbe);
        StrictMode.setThreadPolicy((new StrictMode.ThreadPolicy.Builder().permitNetwork().build()));
        collectData();
        CustomListView1 customListView = new CustomListView1(this,title1,script,img);
        listView1.setAdapter(customListView);
        Cart = (Button) findViewById(R.id.btCart);
...
//                img[i]=jo.getString("photo");
    ...
    public class CustomListView1 extends ArrayAdapter<String> {
        ...
        Bitmap bitmap;
        public CustomListView1(Activity context,String[] title,String[] script,String[] img) {
            ...
            ViewHolder(View v){
                ...
                Cart.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(insertData==true){
                            Toast.makeText(Beverage_Activity.this,"加入購物車！",Toast.LENGTH_LONG).show();
                        }else{
                            Toast.makeText(Beverage_Activity.this,"Something went wrong :(.",Toast.LENGTH_LONG).show();
                        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.beverage_, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent gofood = new Intent(Beverage_Activity.this,Food_Activity.class);
